...
--------------------------------------------------------------------------------
   TYPE memoryArray IS ARRAY ( 256 DOWNTO 0 ) OF std_logic_vector( 31 DOWNTO 0);
...
--------------------------------------------------------------------------------
   ...
   SIGNAL s_dataOutReg    : std_logic_vector( 31 DOWNTO 0 );
   SIGNAL s_memContents   : memoryArray;
   SIGNAL s_oe            : std_logic;
   SIGNAL s_oeReg         : std_logic;
   SIGNAL s_ramdataOut    : std_logic_vector( 31 DOWNTO 0 );
